...
export interface ApiListnameListname extends Struct.CollectionTypeSchema {
  collectionName: 'listnames';
  info: {
    displayName: 'listname';
    pluralName: 'listnames';
...
export interface ApiVoteVote extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::vote.vote'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    toProposal: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    voterAddress: Schema.Attribute.Text;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::listname.listname': ApiListnameListname;
